...
qual_fig <- qa_cycle_q_df %>% 
      ...
      geom_smooth(aes(weight = count, group = Read), color = "black") +
      theme_bw() +
...
ggarrange(lib_size_fig, qual_fig, ncol = 1, nrow = 2,labels = "AUTO")
```
...
```{r readCount, fig.cap="Distribution in the number of reads per barcoded sample (Library Size) by individual. Dashed horizontal line indicates overall median library size.", fig.lp = "fig:", warning=FALSE, message=FALSE, echo = FALSE }
