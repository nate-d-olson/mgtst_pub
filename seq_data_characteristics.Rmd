...
ggarrange(lib_size_fig, feat_fig, qual_fig, ncol = 1, nrow = 3,labels = "AUTO",common.legend = TRUE, align = "v", legend = "bottom")
```

```{r readsVfeats, fig.cap = "Relationship between the number of reads and features per sample by bioinformatic pipeline."}
