...
slope_logFC <- logFC_feature_summary %>% 
      ...
      geom_hline(aes(yintercept = 0), color = "darkorange") + 
...
r2_logFC <- logFC_feature_summary %>% 
      ...
      geom_hline(aes(yintercept = 1), color = "darkorange") + 
      facet_wrap(~biosample_id) +
      theme_bw() +
