...
Additionally, we compared the log-fold change error distribution for log-fold change estimates using different normalization methods (Supplemental Fig. \@ref(fig:logfcNormComp)). 
