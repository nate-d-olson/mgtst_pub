...
slope_logFC <- logFC_feature_summary %>% 
      ...
      theme_bw() +
      labs(x = "Individual", y = "1 - Slope", color = "Pipeline") 
...
r2_logFC <- logFC_feature_summary %>% 
      ...
      facet_wrap(~biosample_id) +
      theme_bw() +
      labs(x = "Individual", y = "Adjusted $R^2$", color = "Pipeline")
```
