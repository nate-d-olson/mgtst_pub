...
```{r qualTidy, message = FALSE, echo = FALSE, warning = FALSE}
...
```{r qualPlotCode, message = FALSE, echo = FALSE, warning = FALSE}
## Multipannel plots
...
There are a number of unmixed- and titration-specific features with a range of observed (titration-specific) and expected (unmix-specific) counts. (Fig. \@ref(fig:qualPlot)A-B). 
To determine if the observed and expected counts could be explained by sampling alone a binomial test was used for titration-specific features and a bayesian hypothesis test was used for unmixed-specific features. 
