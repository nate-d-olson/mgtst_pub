...
# Feature categories
Objective of this categorization is to identify a set of features we would expect to be well behaved based on presence/ absence data alone. 
Informative features will be used for quantitative analysis and uninformative features qualitative analysis.  
