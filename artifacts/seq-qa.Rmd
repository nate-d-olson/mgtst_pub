...
---
<!-- TODO 
Need to clean-up - moving appropriate data objects to data, i.e. incorporating ProjectTemplate structure
-->
...
qa_cycle_q_df %>% filter(sampleID != "NTC") %>% ggplot(aes(x = amp_pos, y = score)) + 
