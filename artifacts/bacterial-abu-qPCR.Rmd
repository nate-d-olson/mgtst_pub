...
__NEED TO FIGURE OUT WHY THE SAMPLE CONCENTRATIONS ARE GREATER THAN 10 NG/UL__ 

```{r fig.cap = "Predicted mixture study sample concentrations."}
...
For titrations $2^{-5}$ the maximum amount of bacterial DNA from the post treatment sample is 0.65 ng/ul. 
This is assuming an initial sample consentation of 10 ng/ul and all of the DNA is bacterial. 
