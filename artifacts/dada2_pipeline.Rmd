...
1. Quality filter read pairs, remove reads with ambiguous bases (Ns) or more than 6 expected errors, trim ends of reads with quality score of 2 or to 290 bp and 220 bp for forward and reverse reads respectively, and the first 10 bases are trimmed.  
