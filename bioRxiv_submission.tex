...
Overall the observed relative and differential abundance values were consistent with the expected values. 
...
equimolar and staggered concentration are used to assess the quantitative accuracy of relative
abundance estimates \cite{Kopylova2014}. Results
...
Samples collected at multiple time points during a Enterotoxigenic
...
participants (subjects) and sampling time points were selected based on
...
Post ETEC exposure (POST) samples were identified as the time point after
...
availability, for E01JH0016 the time point with the second highest
...
\begin{figure}
\centering
\includegraphics[width=12cm]{springer_abundance_files/figure-latex/qaPlots-1.pdf}
...
\begin{figure}
\centering
\includegraphics[width=12cm]{springer_abundance_files/figure-latex/readsVfeats-1.pdf}
...
\begin{figure}
\centering
\includegraphics[width=12cm]{springer_abundance_files/figure-latex/pipeTaxa-1.pdf}
...
\begin{figure}
\centering
\includegraphics[width=12cm]{springer_abundance_files/figure-latex/bacPlot-1.pdf}
...
consistent across pipelines but not subject whereas the size of the \(\theta\)
95\% CI varied by both subject and pipeline. For study subjects
...
\begin{figure}
\centering
\includegraphics[width=12cm]{springer_abundance_files/figure-latex/thetaHat-1.pdf}
...
estimate of 1000 bootstrap theta estimates and error bars 95\% confidence
...
\begin{figure}
\centering
\includegraphics[width=12cm]{springer_abundance_files/figure-latex/qualPlot-1.pdf}
...
\begin{figure}
\centering
\includegraphics[width=12cm]{springer_abundance_files/figure-latex/relAbuError-1.pdf}
...
\begin{figure}
\centering
\includegraphics[width=12cm]{springer_abundance_files/figure-latex/relAbuErrorMetrics-1.pdf}
...
\begin{figure}
\centering
\includegraphics[width=12cm]{springer_abundance_files/figure-latex/logFCerror-1.pdf}
...
\begin{figure}
\centering
\includegraphics[width=12cm]{springer_abundance_files/figure-latex/logFcErrorMetrics-1.pdf}
...
quantitatively assessed count tables by comparing feature relative and
...
The authors would like to thank Mihai Pop, Scott Pine, Scott Jackson, Justin Zook, and Prachi Kulkarni for
