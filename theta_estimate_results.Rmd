...
To account for differences in the proportion of prokaryotic DNA in the pre- and post-exposure (Fig. \@ref(fig:bacPlot)) we inferred $\theta$, proportion of post-exposure sample prokaryotic DNA in a titration, using the 16S rRNA sequencing data (Fig. \@ref(fig:thetaHat)). 
