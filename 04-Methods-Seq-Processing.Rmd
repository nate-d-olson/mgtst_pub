## Sequence Processing
Sequence data was processed using a number of commonly used pipelines, Mothuur [@schloss2009introducing], QIIME [@caporaso2010qiime], DADA2 [@callahan2016dada2], and an in-house pipeline with de-novo clustering phylogenetic placement.
