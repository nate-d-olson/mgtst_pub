...
### Microbiome-Scale Theta Estimates
...
<!--
Relationship between theta estimates - biological replicates - and bioinformatic pipeline
-->
...
* Why quantitative analysis is biological replicate dependent?  
      - What dependency means for 16S gene surveys, when does bioinformatic pipeline matter and when does it not matter?S
