...
However, the sequencing error profile is not completely understood and therefore simulated sequencing data does not recapitulate sequencing data generated from an environmental sample. 
...
Data generated from environmental samples, which include the biases, noise, and diversity of real samples, are often used to benchmark new molecular laboratory and computational methods. 
