...
Next we evaluated the quantitative accuracy of the relative abundance values by comparing the distribution of the feature-level median error and feature-level robust coefficient (RCOV=(IQR)/|median|) of variation for the relative abundance error rate across pipelines (Fig. \@ref(fig:relAbuError)). 
