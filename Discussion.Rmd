...
The sparsity was comparable to previously published values, 1-3\% [@paulson2013differential].
As the dataset is highly redundant, 180 samples derived from 10 environmental samples, we expected lower sparsity. <!-- You haven't defined what you mean by sparsity here yet (at least not in the sections I read -->
...
The 16S rRNA region sequenced in the study is larger than the region the _de-novo_ and open clustering pipelines were initially developed for, potentially explaining the higher than expected sparsity [@kozich2013development] __QIIME V4 REF__. <!-- then why not cut off/trim the region?? -->
...
However, both the _de-novo_ and open-reference clustering pipelines produced count tables with magnitudes higher <!-- this is unclear --> than expected features in evaluation studies using defined mixtures of cell and DNA, mock communities __REF__. 
...
False negatives provide a potential explanation for the higher than expected sparsity. <!-- This whole section is a bit hard to follow, which method you are talking about where -->
