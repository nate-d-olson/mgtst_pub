---
title: "Microbiome Scale Theta Estimate Results NIST1"
author: "Nate Olson"
date: '`r Sys.Date()`'
output:
...
## Raw counts 
raw_counts <- readRDS("~/Desktop/nist1_raw_counts.RDS")

## Negative Binomial Summaries
nb_counts <- readRDS("~/Desktop/nist1_nb_counts.RDS") 
...
pa_summary_anno_df <- readRDS("~/Desktop/nist1_pa_summary_anno_df.RDS")
...
pre_post_logFC_df <- readRDS("~/Desktop/nist2_logFC_edgeR_df.rds") %>% 
...
boot_theta_file <- "~/Desktop/nist1_bootstrap_theta_estimates.rds"
