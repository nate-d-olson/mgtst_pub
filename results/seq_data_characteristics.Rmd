...
__Intro sentence for paragraph__
Quality assessment of sequencing runs summarizing number of reads per sample.
Two barcoded experimental samples have less than 35,000 reads (Fig. \@ref(fig:qaPlots)A). The rest of the samples with less than 35,000 reads are no template PCR controls (NTC). 
