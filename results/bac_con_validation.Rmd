...
<!--
HCB: This sentence is incomplete. Reads like a figure caption. Please revise
Prokaryotic DNA concentration changes across titrations indicating the proportion of bacterial DNA from the unmixed pre- and post-exposure samples in a titration is not consistent with the mixture design (Fig. \@ref(fig:bacPlot)).
-->
