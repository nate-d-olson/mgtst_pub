...
Changes in prokaryotic DNA concentration across titrations were observed, indicating the proportion of bacterial DNA from the unmixed pre- and post-exposure samples in a titration is inconsistent with the mixture design (Fig. \@ref(fig:bacPlot)).
