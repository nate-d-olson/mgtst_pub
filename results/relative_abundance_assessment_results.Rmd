...
To assess the feature-level quantitative accuracy of the relative abundance values we compared the relative abundance feature-level bias, (median error rate, Fig. \@ref(fig:relAbuError)C), and variance, ($RCOV=(IQR)/|median|$ Fig. \@ref(fig:relAbuError)D) across pipelines and individuals using a mixed effects model. 
