...
However, as $\theta$ was not corrected for differences in the proportion of prokaryotic DNA between the unmixed PRE and POST samples we are unable to say whether Mothur's performance was better than the other pipelines.
