...
To account for differences in the proportion of prokaryotic DNA in PRE and POST samples (Fig. \@ref(fig:bacPlot)) we inferred the proportion of POST sample prokaryotic DNA in a titration, $\theta$, using the 16S rRNA sequencing data (Fig. \@ref(fig:thetaHat)).
...
These results were consistent with the qPCR prokaryotic DNA concentration results with significantly positive slopes for E01JH0004 and E01JH0016 and a significantly negative slope for E01JH0038 (Fig. \@ref(fig:bacPlot)).
