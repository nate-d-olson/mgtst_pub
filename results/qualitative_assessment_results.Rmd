...
unmix_count_plot <- ggplot(unmix_plot_df) +
      ...
      theme_bw() +
      labs(x = "Subject", y = "Expected Counts") +
...
For mixture datasets the low abundance features present only in the unmixed samples and mixtures are expected due to random sampling.
For our two-sample titration dataset there were unmixed-specific features with expected counts that could not be explained by sampling alone for all individuals and bioinformatic pipelines (Fig. \@ref(fig:qualPlot)C).
